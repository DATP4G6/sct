namespace Sct.Runtime
{
    ...
    {
        public static IRuntimeContext Create()
        {
            return new RuntimeContext(new AgentHandler(), new QueryHandler([]));
        }
        ...
        {
            return new RuntimeContext(new AgentHandler(), new QueryHandler(ctx.AgentHandler.Agents));
        }
    }
}
